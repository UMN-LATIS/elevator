...
<div class="row infoRow">
	<div class="col-md-12">
		<span class="glyphicon glyphicon-info-sign infoPopover" data-placement="bottom" data-toggle="popover" title="File Info" data-html=true data-content='<ul class="list-group">
			<li class="list-group-item"><strong>File Type: </strong> Unknown <button class="showDetails btn btn-primary btn-xs pull-right"><span class="glyphicon glyphicon-align-justify"></span>Show Details</button></li>
