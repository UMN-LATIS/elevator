...
$downloadArray["Download Derivative (pdf)"] = instance_url("fileManager/getDerivativeById/". $fileObjectId . "/pdf");
}
...
<div class="row assetViewRow">
	<div class="col-md-12">
        <iframe width="100%" height="<?=$embedHeight?>" title="Embedded Spectroscopy Chart" src="<?=$fileObject->getEmedURL()?>" frameborder="0" allowfullscreen class="imageEmbedFrame"></iframe>
    </div>
</div>
