...
<div class="row assetViewRow">
	<div class="col-md-12">
        <iframe width="100%" height="480" data-ratio="0.75" title="Embedded PDF" src="<?=$fileObject->getEmbedURL(true)?>" frameborder="0" allowfullscreen class="pdfEmbedFrame embedAsset"></iframe>
    </div>
</div>
