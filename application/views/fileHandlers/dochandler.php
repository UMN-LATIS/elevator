...
<?endif?>
		...
		<a href="<?=instance_url("fileManager/getOriginal/". $fileObjectId)?>">
			...
			<img src="/assets/icons/512px/doc.png" class="img-responsive" style="width: 50%; margin-left:auto; margin-right:auto"/>
...
<div class="row infoRow">
	<div class="col-md-12">
		<span class="glyphicon glyphicon-info-sign infoPopover" data-placement="bottom" data-toggle="popover" title="File Info" data-html=true data-content='<ul class="list-group">
			<li class="list-group-item"><strong>File Type: </strong> DOC <button class="showDetails btn btn-primary btn-xs pull-right"><span class="glyphicon glyphicon-align-justify"></span>Show Details</button></li>
