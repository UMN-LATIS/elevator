...
<p>
    <b>Actions:</b>&nbsp;
    <a class="btn btn-small" href="<?=instance_url("admin/beanstalk/")?>?tube=<?php echo $tube?>&action=kick&count=1"><i class="icon-play"></i> Kick 1 job</a>
    <a class="btn btn-small" href="<?=instance_url("admin/beanstalk/")?>?tube=<?php echo $tube?>&action=kick&count=10"><i class="icon-forward"></i> Kick 10 jobs</a>
...
<?php foreach($peek as $state=>$job):?>
    ...
    <div class="pull-right">
        <a class="btn btn-danger btn-small" href="<?=instance_url("admin/beanstalk/")?>?tube=<?php echo $tube?>&state=<?php echo $state ?>&action=delete&count=1"><i class="icon-trash icon-white"></i> Delete next <?php echo $state ?> job</a>
        <a class="btn btn-danger btn-small" href="<?=instance_url("admin/beanstalk/")?>?tube=<?php echo $tube?>&state=<?php echo $state ?>&action=deleteAll&count=1" onclick="return confirm('This process might hang a while on tubes with lots of jobs. Are you sure you want to continue?');"><i class="icon-trash icon-white"></i> Delete all <?php echo $state ?> jobs</a>
    </div>
