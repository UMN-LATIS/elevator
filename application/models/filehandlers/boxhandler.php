...
class BoxHandler extends FileHandlerBase {
	...
	protected $supportedTypes = array("pptx", "ppt", "doc", "docx", "pdf", "xls", "xlsx");
	 ...
	 */
	public function getSignedURLs($stripHTTP=false) {

		if(!isset($this->derivatives['boxView'])) {
			return array();
		}

		$boxView = $this->derivatives['boxView'];

		$fileList = $this->s3model->getFilesAtKeyPath($boxView->storageKey);
