...
class FileContainerS3 extends FileContainer {
	...
	public function copyToRemoteStorage($withExtension=null) {
		return $this->parent->s3model->putObject($this->getPathToLocalFile(), $this->storageKey . $withExtension, $this->storageClass);
	 ...
	 */
	public function getProtectedURLForFile($appendedString=null) {
		return $this->parent->s3model->getProtectedURL($this->storageKey . $appendedString, $this->originalFilename);
	}
