...
function MeasurementData(dataObject, Lt) {
  ...
  MeasurementData.prototype.insertZeroGrowth = function (i, latLng) {
    ...
    new_points[k] = {
      ...
      'skip': false,
      'break': false,
      'year': firstYearAdjusted,
      'earlywood': firstEWCheck,
      'latLng': latLng
    };
    ...
    if (subAnnualIncrement) {
      new_points[k] = {
        ...
        'skip': false,
        'break': false,
        'year': secondYearAdjusted,
        'earlywood': secondEWCheck,
        'latLng': latLng
      };
      k++;
    }
...
function MarkerIcon(color, imagePath) {
  ...
  var colors = {
    'light_blue': {
      'path': imagePath + 'images/light_blue_rect_circle_dot_crosshair.png',
      'size': [32, 48]
    },
    'dark_blue': {
      'path': imagePath + 'images/dark_blue_rect_circle_dot_crosshair.png',
      'size': [32, 48]
    },
    'white_start': {
      'path': imagePath + 'images/white_tick_icon.png',
      'size': [32, 48]
    },
    'white_break': {
      'path': imagePath + 'images/white_rect_circle_dot_crosshair.png',
      'size': [32, 48]
    },
    'red': {
      'path': imagePath + 'images/red_dot_icon.png',
      'size': [12, 12]
    },
    'light_red': {
      'path': imagePath + 'images/cb_light_red_tick_icon.png',
      'size': [32, 48]
    },
    'pale_red': {
      'path': imagePath + 'images/cb_pale_red_tick_icon.png',
      'size': [32, 48]
    },
  };
...
function SaveCloud(Lt) {
  ...
  SaveCloud.prototype.action = function () {
    if (Lt.meta.savePermission && Lt.meta.saveURL != "") {
      ...
      $.post(Lt.meta.saveURL, {
          sidecarContent: JSON.stringify(dataJSON)
        })
        .done((msg) => {
          this.displayDate();
          Lt.metaDataText.updateText();
